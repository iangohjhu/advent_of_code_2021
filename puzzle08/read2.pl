# day08 part 2 For each entry, determine all of the wire/segment connections and decode the four-digit output values. What do you get if you add up all of the output values?

# $file='sample_input.txt';
# Adding up all the output values: 61229

$file='actual_input.txt';
# Adding up all the output values: 998900
...
sub readInput()
{
 ...
 #   	print $line;    
		...
		my $output_value = processLine($line);
#		print $line . ":"  . $output_value . "\n";
...
sub displayOutput()
{
	print "Adding up all the output values: $total_output_value\n";
}
...
#};
	...
	{
		$total_value = (10 * $total_value) + $number_hash{sortStr($word)};
	}
